#Importando los componentes que necesitaremos de Tkinter.
from tkinter import Tk, Button, PhotoImage, Label, LabelFrame, W, E, N, S, Entry, END, StringVar, Scrollbar,Toplevel
from tkinter import ttk #Promoviendo acceso de Tk a temas y componentes.

#Importando modulo de Sqlite3.
import sqlite3
...
class Contacts:
    ...
    #Ubicacion de Icono en la ventana.
    def create_left_icon(self):
        photo = PhotoImage(file='/home/w2k31984/Desktop/contacts/icons/logo.png')
        label = Label(image=photo)
        label.image = photo
        label.grid(row=0, column=0)

    #Creacion del frame donde estara el ingreso de informacion.
    ...
    #Mensaje de creacion de nuevo contacto
